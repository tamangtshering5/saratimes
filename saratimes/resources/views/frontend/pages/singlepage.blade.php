...
<div class="add-section separator-large2">
    <div class="container">
        @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$cat_id]])->take(1)->get() as $big)
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h3 class="title-bg">{{$cata_name->catagory}}</h3>
                @foreach($datas->chunk(2) as $data)
                    <div class="row">
                        ...
                        <ul>
                            <li>
                                <div class="blog-image">
                                    <a href="{{route('detailpage',['slug'=>$datum->id])}}">
                                        <i class="fa fa-link" aria-hidden="true"></i>
                                        <img src="{{URL::to('backend/images/post/'.$datum->main_image)}}" alt="{{$datum->main_image}}">
                                    </a>
                                </div>

                                <h3><a href="{{route('detailpage',['slug'=>$datum->id])}}">{{$datum->title}}</a></h3>
                    ...
                    @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$cat_id]])->skip(1)->take(1)->get() as $big)
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a href="{{$big->url}}" target="_blank"><img src="{{URL::to('backend/images/bigyapan/'.$big->image)}}" alt="footer"></a>
                            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                @foreach(App\Bigyapan::where([['position','=','side'],['catagory_id','=',$cat_id]])->get() as $big)
                <div class="add">
...
<div class="add-section separator-large2">
    <div class="container">
            ...
            @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$cat_id]])->skip(2)->take(3)->get() as $big)
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
