...
<div class="add-section separator-large2">
    <div class="container">
        @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$datas->catagory_id]])->take(1)->get() as $big)
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="add-section separator-large2">
                    <div class="container">
                        @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$datas->catagory_id]])->skip(1)->take(1)->get() as $big)
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <a href="{{$big->url}}" target="_blank"><img src="{{URL::to('backend/images/bigyapan/'.$big->image)}}" alt="footer"></a>
                            </div>
                ...
                <div class="add-section separator-large2">
                    <div class="container">
                        <div class="row">
                            @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$datas->catagory_id]])->skip(2)->take(1)->get() as $big)
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        <a href="{{$big->url}}" target="_blank"><img src="{{URL::to('backend/images/bigyapan/'.$big->image)}}" alt="footer"></a>
                                    </div>
                ...
                <div class="add-section separator-large2">
                    <div class="container">
                        <div class="row">
                            @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$datas->catagory_id]])->skip(3)->take(1)->get() as $big)
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        <a href="{{$big->url}}" target="_blank"><img src="{{URL::to('backend/images/bigyapan/'.$big->image)}}" alt="footer"></a>
                                    </div>
                ...
                <div class="like-section">
                    ...
                    <div class="row">
                        @foreach($datas->Catagory as $da)
                            @foreach(App\Catagory::find($da->pivot->catagory_id)->Post()->orderBy('id','desc')->take(6)->get() as $dat)
                ...
                <div class="leave-comments-area">
                    ...
                    <form method="post" action="{{route('comment')}}" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            {{--@foreach($datas->Catagory as $ca)
                            <div class="form-group">
                                <input type="text" name="catagory_id" value="{{$ca->pivot->catagory_id}}" required class="form-control">
                            </div>
                            @endforeach--}}
                            <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                @foreach(App\Bigyapan::where([['position','=','side'],['catagory_id','=',$datas->catagory_id]])->get() as $big)
                <div class="add">
...
<div class="add-section separator-large2">
    <div class="container">
        <div class="row">
            @foreach(App\Bigyapan::where([['position','=','flat'],['catagory_id','=',$datas->catagory_id]])->skip(5)->take(1)->get() as $big)
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <img src="{{URL::to('backend/images/bigyapan/'.$big->image)}}" alt="footer">
            </div>
                @endforeach
