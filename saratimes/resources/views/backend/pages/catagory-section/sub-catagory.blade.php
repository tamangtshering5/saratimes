            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post" action="{{route('subcatagory_action')}}">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="subcatagory" id="subcatagory" class="form-control" value="{{old('subcatagory')}}" placeholder="Enter subcatagory name">
                                </div>
                            </div>
