    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
                ...
                @endif
                <div class="x_title">
                    <h2>Catagory <small>this is add catagory section</small></h2>
                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" action="{{route('catagory_action')}}">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Catagory</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" name="catagory" id="catagory" class="form-control" value="{{old('catagory')}}" placeholder="Enter catagory name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" name="slug" id="slug" class="form-control" value="{{old('slug')}}" placeholder="Enter catagory name" readonly>
                            </div>
                        </div>
